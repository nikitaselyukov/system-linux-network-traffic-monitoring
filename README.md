**SnapshotD**  
**SnapshotD** — учебный проект по Linux-системному программированию для регулярного резервного копирования каталогов в фоновом режиме.  
Проект использует systemd-таймер и отдельный worker-процесс на C++, а управление выполняется через CLI-утилиту snapshotctl.  
**Что реализовано**  
